...
class QueryOptimizer:
    ...
    async def get_dashboard_data_optimized(self) -> Dict[str, Any]:
        ...
        try:
            ...
            tasks = [self._get_latest_temperatures(), self._get_open_alerts(), self._get_health_metrics()]
    ...
    async def _execute_query(self, query: str, params: List = None) -> List[Dict]:
        ...
        return await loop.run_in_executor(self.executor, functools.partial(self._execute_sync_query, query, params))
    ...
    def _normalize_device_type(self, device_type: str) -> str:
        ...
        type_mapping = {"undercounter": "chiller", "room_temp": "ambient", "chiller": "chiller", "freezer": "freezer"}
