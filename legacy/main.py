...
@app.get("/frontend/landing.html", tags=["UI"])
async def serve_landing():
    # Menyajikan file landing.html jika diakses langsung
    if os.path.exists("frontend/landing.html"):
...
if os.path.exists("frontend/dashboard"):
    app.mount("/frontend/dashboard", StaticFiles(directory="frontend/dashboard", html=True), name="dashboard")
