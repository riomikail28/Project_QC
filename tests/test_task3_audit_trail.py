...
def test_task3_admin_audit_logs_can_filter_by_date_action_and_user(client, admin_headers):
    db = FakeSupabase({"audit_logs": [
        {"id": "audit-1", "action": "submit_temperature", "actor_id": "staff-1", "entity_type": "facility_log", "created_at": "2026-05-16T01:00:00Z"},
        {"id": "audit-2", "action": "approve_qc", "actor_id": "admin-1", "entity_type": "qc_report", "created_at": "2026-05-17T01:00:00Z"},
    ]})
